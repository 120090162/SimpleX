...
# Loading the anymal model from local assets
urdf_path = _ASSETS_DIR / "anymal_c_simple_description" / "urdf" / "anymal.urdf"
srdf_path = _ASSETS_DIR / "anymal_c_simple_description" / "srdf" / "anymal.srdf"
mesh_dir = _ASSETS_DIR / "anymal_c_simple_description" / "meshes"

model, collision_model, visual_model = pinocchio.buildModelsFromUrdf(
    str(urdf_path), str(mesh_dir), pinocchio.JointModelFreeFlyer()
)
pinocchio.loadReferenceConfigurations(model, str(srdf_path), False)
anymal = RobotWrapper(model, collision_model, visual_model)
