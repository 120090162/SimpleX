...
print("Loading go2 robot description...")
import os

current_dir = os.path.dirname(os.path.abspath(__file__))

xml_path = f"{current_dir}/../../assets/unitree_go2/go2.xml"
# xml_path = f"{current_dir}/../robots/go2/mjcf/go2.xml"

model = pin.buildModelFromMJCF(xml_path)

collision_model = pin.buildGeomFromMJCF(model, xml_path, pin.GeometryType.COLLISION)
visual_model = pin.buildGeomFromMJCF(model, xml_path, pin.GeometryType.VISUAL)

robot_mj = pin.RobotWrapper(
